...
const studentDefaultValues = {
  ...
  // admissionSemester: "65b0104110b74fcbd7a25d92",
  // academicDepartment: "65b0104110b74fcbd7a25d92",
};
const CreateStudent = () => {
  ...
  const { data: dData, isLoading: dIsLoading } = useGetAcademicDepartmentsQuery(
    undefined,
    { skip: sIsLoading } //? if we want a fetch to be depended on another fetch use skip | ie it will fetch after previous fetch is completed
  );
      ...
      <Col span={24}>
        <PHForm onSubmit={onSubmit} defaultValues={studentDefaultValues}>
          ...
          <Row gutter={8}>
            ...
            {/* For uploading image a bit tricky */}
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
              <Controller
                name="image"
